...
def seed_products(c, db):
    ...
    products = [
        ...
        ("VIP", "vip", "rank", "global", 299, 399,
         ...
         "ic-star", "#4ade80", 1, 1),
        ("VIP+", "vip+", "rank", "global", 699, 799,
         "Enhanced VIP with cyan flair, stronger perks, and extra lobby utility.",
        ...
        ("MVP+", "mvp+", "rank", "global", 2799, 3399,
         ...
         "ic-heart", "#f43f5e", 1, 4),
        ("MVP++", "mvp++", "rank", "global", 3499, 3999,
         "The ultimate prestige rank. Pink flair, top-tier perks, and the full Hellcore package.",
